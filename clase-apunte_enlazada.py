...
def main():
  lista = None
  lista = agregar_al_final(lista, Mascota("Luis"))
  lista = agregar_al_final(lista, Mascota("Leon"))
  lista = agregar_al_final(lista, Mascota("Pip"))
  lista = agregar_al_inicio(lista, Mascota("Link"))
  print("Antes de eliminar: ")
  imprimir_lista(lista)  # Link, Luis, Leon
  lista = eliminar(lista, Mascota("Pip"))
  print("Después de eliminar: ")
  imprimir_lista(lista)  # Luis, Leon
  print(existe(lista, Mascota("Link")))  # False
  print(existe(lista, Mascota("Pip")))  # True
